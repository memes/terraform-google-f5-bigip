...
resource "google_compute_address" "alpha_private" {
  ...
  name         = format(format("%s-%s-%s-alpha-priv", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
  subnetwork   = var.alpha_subnets[var.region]
...
resource "google_compute_address" "alpha_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-%s-alpha-pub", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
...
resource "google_compute_address" "beta_private" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-%s-beta-priv", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
  subnetwork   = var.beta_subnets[var.region]
  address_type = "INTERNAL"
  region       = var.region
}
...
resource "google_compute_address" "beta_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-%s-beta-pub", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
  address_type = "EXTERNAL"
  region       = var.region
...
resource "google_compute_address" "gamma_private" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-%s-gamma-priv", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
  subnetwork   = var.gamma_subnets[var.region]
  address_type = "INTERNAL"
  region       = var.region
}
...
resource "google_compute_address" "gamma_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-%s-gamma-pub", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
  address_type = "EXTERNAL"
  region       = var.region
...
resource "google_compute_address" "delta_private" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-%s-delta-priv", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
  subnetwork   = var.delta_subnets[var.region]
  address_type = "INTERNAL"
  region       = var.region
}
...
resource "google_compute_address" "epsilon_private" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-%s-epsilon-priv", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
  subnetwork   = var.epsilon_subnets[var.region]
  address_type = "INTERNAL"
  region       = var.region
}
...
resource "google_compute_address" "epsilon_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-%s-epsilon-pub", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
  address_type = "EXTERNAL"
  region       = var.region
  network_tier = var.internal_subnetwork_tier
}
...
resource "google_compute_address" "zeta_private" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-%s-zeta-priv", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
  subnetwork   = var.zeta_subnets[var.region]
  address_type = "INTERNAL"
  region       = var.region
}
...
resource "google_compute_address" "zeta_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-%s-zeta-pub", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
  address_type = "EXTERNAL"
  region       = var.region
  network_tier = var.internal_subnetwork_tier
}
...
resource "google_compute_address" "eta_private" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-%s-eta-priv", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
  subnetwork   = var.eta_subnets[var.region]
  address_type = "INTERNAL"
  region       = var.region
}
...
resource "google_compute_address" "eta_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-%s-eta-pub", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
  address_type = "EXTERNAL"
  region       = var.region
  network_tier = var.internal_subnetwork_tier
}
...
resource "google_compute_address" "theta_private" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-%s-theta-priv", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
  subnetwork   = var.theta_subnets[var.region]
  address_type = "INTERNAL"
  region       = var.region
}
...
resource "google_compute_address" "theta_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-%s-theta-pub", var.prefix, var.bigip_version, var.instance_name_template), count.index + var.instance_ordinal_offset)
  address_type = "EXTERNAL"
  region       = var.region
  network_tier = var.internal_subnetwork_tier
}
