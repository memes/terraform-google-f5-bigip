...
output "external_addresses" {
  value       = module.cfe.external_addresses
  description = <<EOD
...
output "external_vips" {
  value       = module.cfe.external_vips
  description = <<EOD
...
output "management_addresses" {
  value       = module.cfe.management_addresses
  description = <<EOD
...
output "internal_addresses" {
  value       = module.cfe.internal_addresses
  description = <<EOD
...
output "external_public_ips" {
  value       = module.cfe.external_public_ips
  description = <<EOD
...
output "management_public_ips" {
  value       = module.cfe.management_public_ips
  description = <<EOD
...
output "internal_public_ips" {
  value       = module.cfe.internal_public_ips
  description = <<EOD
...
output "zone_instances" {
  value       = module.cfe.zone_instances
  description = <<EOD
