...
resource "google_compute_address" "alpha_private" {
  ...
  name         = format(format("%s-%s-alpha-priv", var.prefix, var.instance_name_template), count.index)
...
resource "google_compute_address" "alpha_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-alpha-pub", var.prefix, var.instance_name_template), count.index)
...
resource "google_compute_address" "beta_private" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-beta-priv", var.prefix, var.instance_name_template), count.index)
...
resource "google_compute_address" "beta_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-beta-pub", var.prefix, var.instance_name_template), count.index)
  address_type = "EXTERNAL"
  region       = var.region
...
resource "google_compute_address" "gamma_private" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-gamma-priv", var.prefix, var.instance_name_template), count.index)
...
resource "google_compute_address" "gamma_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-gamma-pub", var.prefix, var.instance_name_template), count.index)
  address_type = "EXTERNAL"
  region       = var.region
...
resource "google_compute_address" "delta_private" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-delta-priv", var.prefix, var.instance_name_template), count.index)
...
resource "google_compute_address" "delta_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-delta-pub", var.prefix, var.instance_name_template), count.index)
  address_type = "EXTERNAL"
  region       = var.region
  network_tier = var.internal_subnetwork_tier
}
...
resource "google_compute_address" "epsilon_private" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-epsilon-priv", var.prefix, var.instance_name_template), count.index)
...
resource "google_compute_address" "epsilon_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-epsilon-pub", var.prefix, var.instance_name_template), count.index)
  address_type = "EXTERNAL"
  region       = var.region
  network_tier = var.internal_subnetwork_tier
}
...
resource "google_compute_address" "zeta_private" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-zeta-priv", var.prefix, var.instance_name_template), count.index)
...
resource "google_compute_address" "zeta_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-zeta-pub", var.prefix, var.instance_name_template), count.index)
  address_type = "EXTERNAL"
  region       = var.region
  network_tier = var.internal_subnetwork_tier
}
...
resource "google_compute_address" "eta_private" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-eta-priv", var.prefix, var.instance_name_template), count.index)
...
resource "google_compute_address" "eta_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-eta-pub", var.prefix, var.instance_name_template), count.index)
  address_type = "EXTERNAL"
  region       = var.region
  network_tier = var.internal_subnetwork_tier
}
...
resource "google_compute_address" "theta_private" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-theta-priv", var.prefix, var.instance_name_template), count.index)
...
resource "google_compute_address" "theta_public" {
  ...
  project      = var.project_id
  name         = format(format("%s-%s-theta-pub", var.prefix, var.instance_name_template), count.index)
  address_type = "EXTERNAL"
  region       = var.region
  network_tier = var.internal_subnetwork_tier
}
