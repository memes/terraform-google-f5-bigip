...
| hostname | An optional hostname declaration to include in generated DO file. Default is an<br>empty string, which will exclude hostname from the DO file. | `string` | `""` | no |
