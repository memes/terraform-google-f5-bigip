...
| hostname\_template | An optional hostname declaration template used to set per-instance hostname in<br>generated DO file. Default is an empty string, which will exclude hostname from<br>the generated DO file. | `string` | `""` | no |
