...
variable "external_subnetwork_vip_cidrs_named_range" {
  ...
  default     = ""
  description = <<EOD
An optional named range to use when assigning CIDRs to *active* BIG-IP instances
as VIPs on their external interface. E.g. to assign CIDRs from secondary range
'dmz-bigip':-
...
variable "management_subnetwork_vip_cidrs_named_range" {
  ...
  default     = ""
  description = <<EOD
An optional named range to use when assigning CIDRs to the *active* BIG-IP
instances as VIPs on their management interface. E.g. to assign CIDRs from
...
variable "internal_subnetwork_vip_cidrs_named_ranges" {
  ...
  default     = []
  description = <<EOD
An optional named range to use when assigning CIDRs to *active* BIG-IP instance
as VIPs on their internal interfaces. E.g. to assign CIDRs from
